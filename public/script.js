...
const rarete5CharactersList = document.getElementById('rarete-5-characters');
const rarete4CharactersList = document.getElementById('rarete-4-characters');
const rarete5WeaponsList = document.getElementById('rarete-5-weapons');
const rarete4WeaponsList = document.getElementById('rarete-4-weapons');

// Function to create an li element for a character or weapon
function createLiElement(item) {
  const li = document.createElement('li');
  li.id = item.id;
  li.className = `element_${item.type} rarete-${item.rarity} ${item.type}_${item.weaponType}`;
